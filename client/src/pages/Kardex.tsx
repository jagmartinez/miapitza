                ...
                <div className="kardex-product-info">
                    <div className="balance-cards-row">
                        ...
                        <div className="balance-card total-in">
                            ...
                            <span className="balance-value in">{kardexData.totals.totalIn.toFixed(3)} {kardexData.product.unit}</span>
                        </div>

                        <div className="balance-card total-out">
                            <span className="balance-label">Total Salidas</span>
                            <span className="balance-value out">{kardexData.totals.totalOut.toFixed(3)} {kardexData.product.unit}</span>
                        </div>
                                ...
                                {pagedMovements.map((movement) => (
                                    <tr key={movement.id}>
                                        ...
                                        <td className={`text-right ${movement.in ? 'movement-in' : ''}`}>
                                            {movement.in ? movement.in.toFixed(3) : '-'}
                                        </td>
